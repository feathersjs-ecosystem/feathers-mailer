...
## [5.0.0](https://github.com/feathersjs-ecosystem/feathers-mailer/tree/v5.0.0) (2026-09-18)

[Full Changelog](https://github.com/feathersjs-ecosystem/feathers-mailer/compare/v4.2.0...v5.0.0) · [Migration from v4](README.md#migration-from-v4)

- **Breaking:** ESM only - `require('feathers-mailer')` no longer works
- **Breaking:** `nodemailer@^10` is now an optional `peerDependency`
- **Breaking:** requires Node.js >= 22.18
- **Breaking:** `lib/` → `dist/`, transport namespaces removed
  (`SMTPTransport.Options` → `SMTPTransportOptions`), `Service` lost its
  `Defaults` type parameter
- Build with tsdown, tests on vitest, lint via `@feathers-community/eslint-config`
- `@types/nodemailer` dropped - `nodemailer@10` ships its own types
- chore!: modernize tooling, go ESM only [\#38](https://github.com/feathersjs-ecosystem/feathers-mailer/pull/38) ([fratzinger](https://github.com/fratzinger))
...
<!-- Entries for v4.2.0 and earlier were generated by github_changelog_generator. -->
